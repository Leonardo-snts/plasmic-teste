...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: Qvdi11EgEKB7/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__aOqGf)}>
        <div className={classNames(projectcss.all, sty.column___12YwD)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__e9Jlt)}>
          <div className={classNames(projectcss.all, sty.columns__jeuwZ)}>
            <div className={classNames(projectcss.all, sty.column__hJXgq)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__jWFtL)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__bgNu)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__leAg)}>
                {renderPlasmicSlot({
