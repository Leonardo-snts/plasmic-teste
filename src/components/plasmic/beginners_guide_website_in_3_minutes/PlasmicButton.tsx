...
import sty from "./PlasmicButton.module.css"; // plasmic-import: UXDz2bFuuALO/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg___6Zyem)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <RightArrowIcon
                className={classNames(projectcss.all, sty.svg__mH8Jq)}
                role={"img"}
              />
            ),
